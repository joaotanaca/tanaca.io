...
const About = () => {
  return (
    ...
    >
      ...
      <h2 className="font-black text-gray-900 text-center text-6xl leading-[4.5rem] pb-6 tracking-tight col-span-12 col-start-1 md:col-span-8 md:col-start-3">
        Olá, eu sou{' '}
        <a
      ...
      <p className="text-gray-500 text-center text-xl font-medium col-span-12 col-start-1 md:col-span-10 md:col-start-2">
      ...
      <div className="col-span-12 grid grid-cols-1 lg:grid-cols-3 gap-x-8 mt-8">
        <SectionCards
          className="col-span-1 flex flex-col-reverse lg:flex-col gap-3"
          cards={experiencesLeft}
        />
        <div className="col-span-1">
          <div className="hidden lg:block relative h-[66%]">
            <Image
              layout="fill"
